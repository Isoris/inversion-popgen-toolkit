...
**Status**: SHIPPED — v0.1 implemented (see paired
`SPEC_comparative_te_breakpoint_fragility__implementation_status.md`
in this folder). Code at `Atlas/_scripts/phase_8_comparative_breakpoint_fragility/`.
Tests at `tests/test_turn123_te_fragility.js`. This forward-looking
spec remains as the design document; the implementation-status
sibling tracks what's actually shipped vs. extension ideas.
