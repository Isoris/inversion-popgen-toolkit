...
# ($BASE/inversion_modules/phase_qc_shelf/results/) to the correct location
...
LIVE_CONFIG="${BASE}/inversion-popgen-toolkit/inversion_modules/phase_qc_shelf/00_config.sh"
BUNDLE_CONFIG="${BASE}/toolkit_update_2026-04-20/modules/phase_qc_shelf/00_config.sh"

OLD_RESULTS="${BASE}/inversion_modules/phase_qc_shelf/results"
...
OLD_LINE=': "${QC_OUT:=${BASE}/inversion_modules/phase_qc_shelf/results}"'
