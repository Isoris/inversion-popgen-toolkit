#!/usr/bin/env bash
# =============================================================================
# LAUNCH_module4e.sh — Submit DELLY BND pipeline to SLURM with dependencies
# =============================================================================
# Usage:
#   cd /scratch/lt200308-agbsci/Quentin_project_KEEP_2026-02-04/delly_sv_BND
...
echo "=== DELLY BND Pipeline (MODULE_4E) Launcher ==="
echo "Script directory: ${SCRIPT_DIR}"
echo "DELLY binary:    ${DELLY_BIN}"
echo "SV type:         BND (delly -t BND)"
echo ""
...
echo "  [2/6] BND discovery: Job ${JID2} (after ${JID1})"
