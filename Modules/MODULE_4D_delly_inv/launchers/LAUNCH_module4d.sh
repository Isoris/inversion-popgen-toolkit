#!/usr/bin/env bash
# =============================================================================
# LAUNCH_module4d.sh — Submit DELLY INV pipeline to SLURM with dependencies
# =============================================================================
# Usage:
#   cd /scratch/lt200308-agbsci/Quentin_project_KEEP_2026-02-04/delly_sv_INV
...
echo "=== DELLY INV Pipeline Launcher ==="
echo "Script directory: ${SCRIPT_DIR}"
echo "DELLY binary:    ${DELLY_BIN}"
echo "SV type:         INV (delly -t INV)"
echo ""
...
echo "  [2/6] INV discovery: Job ${JID2} (after ${JID1})"
