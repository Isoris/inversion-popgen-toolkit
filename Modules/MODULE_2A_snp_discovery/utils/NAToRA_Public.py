###
# NAToRA_Public.py does this:
# Implements NAToRA (Network Algorithm To Relatedness Analysis) for relatedness
# filtering. It builds relatedness networks from pairwise sample scores, detects
# families/components, chooses samples to remove using heuristic or optimal
# graph-based elimination, can generate independent sets, and can run cutoff
# tests across a range of thresholds.
###
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
