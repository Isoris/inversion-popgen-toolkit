#!/usr/bin/env bash
# =============================================================================
# 00_delly_config.sh — Central configuration for DELLY BND pipeline
# =============================================================================
# Adapted from DEL pipeline. SV type: Breakend variants (inter/intra-chromosomal rearrangements)
# DELLY call type: -t BND
# =============================================================================
...
# ── Project root ────────────────────────────────────────────────────────────
DELLY_PROJECT="/scratch/lt200308-agbsci/Quentin_project_KEEP_2026-02-04"
...
# ── Output directories ─────────────────────────────────────────────────────
OUTDIR="${DELLY_PROJECT}/MODULE_4E_BND_Delly"
...
dv_log() { echo "[$(dv_timestamp)] [DELLY-BND] $*"; }
dv_err() { echo "[$(dv_timestamp)] [DELLY-BND] [ERROR] $*" >&2; }
