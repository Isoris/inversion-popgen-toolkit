#!/usr/bin/env bash
# =============================================================================
# LAUNCH_module4f.sh — Submit DELLY TRA pipeline to SLURM with dependencies
# =============================================================================
# Usage:
#   cd /scratch/lt200308-agbsci/Quentin_project_KEEP_2026-02-04/delly_sv_TRA
...
echo "=== DELLY TRA Pipeline Launcher ==="
echo "Script directory: ${SCRIPT_DIR}"
echo "DELLY binary:    ${DELLY_BIN}"
echo "SV type:         TRA (delly -t BND)"
echo ""
...
echo "  [2/6] TRA discovery: Job ${JID2} (after ${JID1})"
