#!/usr/bin/env bash
# =============================================================================
# 00_delly_config.sh — Central configuration for DELLY TRA pipeline
# =============================================================================
# Adapted from DEL pipeline. SV type: Translocations (inter-chromosomal BND events)
...
# ── Output directories ──────────────────────────────────────────────────────
OUTDIR="${BASE}/MODULE_4F_TRA_Delly"
...
dv_log() { echo "[$(dv_timestamp)] [DELLY-TRA] $*"; }
dv_err() { echo "[$(dv_timestamp)] [DELLY-TRA] [ERROR] $*" >&2; }
