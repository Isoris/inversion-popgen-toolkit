...
**Status**: Main panel SHIPPED in turn 119 (see `tests/test_turn119_age_origin.js`,
`tests/test_turn122_age_override_export.js`). §8 Q5 chip and §9 card-flip
deferred. Drafted 2026-05-03, scope = page 3 (DOM `page2`) candidate focus.
