...
**Status:** SHIPPED. Page mounted in `Inversion_atlas.html` (search for
`SV evidence` / `page_sv_evidence`). Producer pipeline + atlas-side rendering
landed across the SV-evidence track and turn 145 server unify. See
`HANDOFF_2026-05-04_FINAL.md` (in `handoffs/archive/2026-05-05_turn128-150/`)
for the original 7-step build log and `tests/test_turn145_server_unify.js`
plus `tests/sv_evidence/` for tests.
