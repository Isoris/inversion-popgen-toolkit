...
CMD_DECOMP="Rscript ${MODULE_DIR}/phase_7_karyotype_groups/proposal/STEP_C01i_decompose.R \
...
CMD_RECOMB="Rscript ${MODULE_DIR}/phase_7_karyotype_groups/proposal/STEP_C01i_b_multi_recomb.R \
  --candidates ${CANDIDATES} \
...
CMD_NESTED="python3 ${MODULE_DIR}/phase_7_karyotype_groups/proposal/STEP_C01i_c_nested_composition.py \
  --candidates ${CANDIDATES} \
...
CMD_SEAL="Rscript ${MODULE_DIR}/phase_7_karyotype_groups/proposal/STEP_C01i_d_seal.R \
  --candidates ${CANDIDATES} \
  --decomp_dir ${DECOMP_OUT} \
