...
three patches applied in order. See `../../phase_9_classification/patches/`
for the originals.
...
- `../../README.md` — module root overview
- `../../phase_9_classification/patches/README.md` — the 3 patches, in application order
- `../../phase_9_classification/patches/_archive_superseded/README.md` — 3 patches NOT to apply
  (two C01i + the obsolete flashlight C01f patch)
- `../proposal/` — where the groups come from (seal writes
  q6_validation_promotion_cap that this phase respects)
