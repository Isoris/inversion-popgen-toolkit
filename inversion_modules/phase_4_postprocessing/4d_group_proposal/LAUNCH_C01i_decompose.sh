...
# ${MODULE_DIR}/phase4b_rewrite/R/. The current tree has it under
# 4d_group_proposal/. This launcher uses the current-tree path.
# =============================================================================
...
"${RSCRIPT_BIN}" \
  "${BASE}/inversion_modules/phase_4_postprocessing/4d_group_proposal/STEP_C01i_decompose.R" \
