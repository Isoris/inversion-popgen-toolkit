# `4e_group_validation/` — validate proposed groups
...
registry (set by `4d_group_proposal/STEP_C01i_d_seal.R` when
...
- `../4d_group_proposal/` — where the groups come from (4b.4 seal
