...
CHAR_SCRIPT="${BASE}/inversion_modules/phase_4_postprocessing/4g_final_classification/run_characterize.R"
STATUS_SCRIPT="${BASE}/inversion_modules/phase_4_postprocessing/4g_final_classification/compute_candidate_status.R"
