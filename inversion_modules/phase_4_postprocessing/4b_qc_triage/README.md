# `4b_qc_triage/` — data-quality QC on candidate shelves

(Formerly the top-level `phase_qc_shelf/` module. Moved into phase_4
as sub-block 4b in pass 12, 2026-04-24. See `docs/PHASE4_RENUMBER_PROPOSAL.md`.)
...
```
inversion_modules/phase_4_postprocessing/4b_qc_triage/
...
```bash
cd ${BASE}/inversion-popgen-toolkit/inversion_modules/phase_4_postprocessing/4b_qc_triage
