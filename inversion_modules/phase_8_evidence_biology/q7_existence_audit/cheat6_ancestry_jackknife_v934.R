...
#
# v9.3.4: Fixed Fst extraction — C binary outputs Fst_<g1>_<g2>, so
#   s$Fst$b1_vs_b3 doesn't exist. Use extract_fst(s) = s$Fst[[1]] instead.
# =============================================================================
...
# Helper: extract single Fst value from dispatcher result
# C binary names column Fst_b1_b3 (not b1_vs_b3). With one group pair,
# there's exactly one Fst column — take the first element.
