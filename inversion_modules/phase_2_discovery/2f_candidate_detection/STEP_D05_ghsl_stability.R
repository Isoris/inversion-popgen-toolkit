...
#
# Can use either:
#   (a) Pre-computed GHSL files with per-window band assignments
#   (b) Direct computation from sim_mat using column-wise clustering
#
# Returns data.frame with columns:
#   candidate_id, partition_stability, n_consistent_windows,
#   dominant_partition_size, partition_entropy
# ============================================================================

# ---- Main: from GHSL output files ----
