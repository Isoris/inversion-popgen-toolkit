...
# Path hack so the test can find the library when run from tests/
HERE = Path(__file__).resolve().parent
API_PY = HERE.parent / "registries" / "api" / "python"
sys.path.insert(0, str(API_PY))

# Also need schemas accessible — the loader expects registries/schemas/ under root
SCHEMAS_SRC = HERE.parent / "registries" / "schemas"
