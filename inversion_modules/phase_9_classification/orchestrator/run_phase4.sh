...
LAUNCH_C01D_PASS1="${MODULE_DIR}/phase_4_catalog/LAUNCH_C01d_scoring_pass1.sh"
LAUNCH_C01G="${MODULE_DIR}/phase_4_catalog/LAUNCH_C01g_boundary.sh"
...
LAUNCH_C01F="${MODULE_DIR}/phase_7_karyotype_groups/validation/LAUNCH_C01f_hypothesis.sh"
LAUNCH_C01D_PASS2="${MODULE_DIR}/phase_9_classification/LAUNCH_C01d_scoring_pass2.sh"
LAUNCH_GROUP_CHEATS="${MODULE_DIR}/phase_8_evidence_biology/orchestrator/LAUNCH_group_cheats.sh"
LAUNCH_CHAR_CLASSIFY="${MODULE_DIR}/phase_9_classification/LAUNCH_characterize_classify.sh"
...
PHASE4B_OUT=$(bash "${MODULE_DIR}/phase_7_karyotype_groups/proposal/orchestrator/run_phase4b.sh" \
  ${DRY_FLAG} \
  --chroms "${CHROMS_CSV}" \
  2>&1 | tee /dev/stderr)
