...
build_key_spec <- function() {
  ...
  # ── Q_QC_SHELF: data-quality QC flags from phase_5_qc_triage (pass 13) ──
  # SOFT flag (candidates keep their tier regardless) produced by the
  # phase_5_qc_triage/ module. Reads from the evidence
  ...
  q_qc_shelf <- c(
    "q_qc_shelf_ran",                    # logical: did phase_5_qc_triage run for this cid?
  ...
  # ALL q_qc_shelf keys are currently aspirational — phase_5_qc_triage
