...
CHAR_SCRIPT="${BASE}/inversion_modules/phase_9_classification/run_characterize.R"
STATUS_SCRIPT="${BASE}/inversion_modules/phase_9_classification/compute_candidate_status.R"
...
# phase_5_qc_triage/STEP_Q10_register.sh (typically the evidence_registry's
