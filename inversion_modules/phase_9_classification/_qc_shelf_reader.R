...
#
# Reads the per-candidate summary.json files that Q10 of phase_5_qc_triage writes
...
#
# FLAG DECISION RULES (thresholds from phase_5_qc_triage/docs/interpretation.md):
