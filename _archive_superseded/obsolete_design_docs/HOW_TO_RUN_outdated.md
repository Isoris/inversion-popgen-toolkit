# =============================================================================
# HOW TO RUN — Inversion Pipeline v8.5  [OUTDATED — 2026-04-17]
# =============================================================================
#
# This document predates the phase_1..6 restructure and the retirement of
# the 1D fuzzy merge (STEP_C01b_2). It still references:
#   - MODULE_5A2_Discovery_Core/snakes/ layout (now phase_2/2c + 2d)
#   - STEP_C01c_triangle_regimes.R (replaced by phase_2/2d staircase)
#   - STEP_C01b_2_merge.R (retired — see _archive_superseded/)
#   - launchers/ at the root (now split per phase)
#
# Kept for reference on parameter semantics and the LANTA launch pattern.
# For current layout see inversion_modules/README.md and each phase's
# README.md.
# =============================================================================
