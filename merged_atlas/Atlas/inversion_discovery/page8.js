...
//
// Per-window summary table — |Z|, λ₁/λ₂, eigenvalue ratio, SNP counts.
// NO JS handlers exist in legacy yet — page is pure HTML scaffold (see page8.html).
// Renderers (winSumTable, winSumStripCanvas, filters) will be authored fresh.
//
