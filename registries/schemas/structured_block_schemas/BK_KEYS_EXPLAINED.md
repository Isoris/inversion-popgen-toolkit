...
**Writer.** `inversion_modules/phase_4_postprocessing/4b_group_proposal/STEP_C01i_decompose.R`
...
**Writer.** `inversion_modules/phase_4_postprocessing/4b_group_proposal/STEP_C01i_b_multi_recomb.R`
...
**Writer.** `inversion_modules/phase_4_postprocessing/4b_group_proposal/STEP_C01i_c_nested_composition.py`
